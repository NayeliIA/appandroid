    ...
    private void cargarMaterialDefinido(String materia){
        ...
        switch (materia){
            ...
            case "GEOGRAFIA":
                ...
                addLinkView("https://docs.google.com/presentation/d/1Z9WWWZam_wZDKclYJh8tUm9Mta4Rh6HteU7lCalww3M/edit?usp=sharing", "Temario General", Color.rgb(15,51,65),20);
                addLinkView("https://drive.google.com/file/d/1RFwEEhBPmKSVqlmGypcn8EWu7OPbJTMO/view?usp=drive_link", "Resumen del Temario",Color.rgb(15,51,65),20 );
                addLinkView("https://youtu.be/mvsOl8s2aJM?si=R3cbPmZ6oc6ZZJ6s", "Tipos de erosión", Color.rgb(15,51,65),20);
            ...
            case "INGLES":
                ...
                addLinkView("https://www.britishcouncil.org.mx/blog/irregular-verbs", "Irregular Verbs", Color.rgb(15,51,65),20);
                addLinkView("https://youtu.be/Nql1Y_TuIEM?si=zaRapJC9P3Y8DpSQ", "Condicionales",Color.rgb(15,51,65),20 );
                addLinkView("https://youtu.be/Sg5lg5ohzMc?si=mMOJDQA-uYIviWHT", "Reported Speech", Color.rgb(15,51,65),20);
                addLinkView("https://www.perfect-english-grammar.com/gerunds-and-infinitives.html", "Gerunds and infinitives", Color.rgb(15,51,65),20);
                addLinkView("https://youtu.be/Yo3-SS79Atk?si=kj1N6awM2_nZP9Rm", "Gerunds and infinitives Part 2", Color.rgb(15,51,65),20);
                addLinkView("https://youtu.be/FM8xxpFS0wk?si=Gp0RJarzkTyHdPob", "Comparative vs superlative", Color.rgb(15,51,65),20);
                addLinkView("https://youtu.be/XACvspcClW0?si=br2DPuj6t4oWyuMW", "Futures in English", Color.rgb(15,51,65),20);
            ...
            case "FILOSOFIA":
                ...
                addLinkView("https://view.genial.ly/64dad9c843f8dc001269a405/presentation-mitos-cosmogonicos", "Mitos Cosmogónicos", Color.rgb(15,51,65),20);
                addLinkView("https://view.genial.ly/5d8026a69b543a0fe680f2d2/presentation-mito", "El mito",Color.rgb(15,51,65),20 );
                addLinkView("https://view.genial.ly/64ebe295220d2f0018ff5420/presentation-pitagoricos", "Pitagóricos", Color.rgb(15,51,65),20);
                addLinkView("https://view.genial.ly/5ea9d53c9065570d9a2f0758/presentation-escuela-eleatica", "Escuela Eleática", Color.rgb(15,51,65),20);
                addLinkView("https://view.genial.ly/64fe5d87a4860700186ef0de/presentation-presentacion-de-heraclito", "Heráclito", Color.rgb(15,51,65),20);
                addLinkView("https://view.genial.ly/650f641d4b3b670011f8f681/presentation-filosofos-pluralistas", "Filosofós Pluralistas", Color.rgb(15,51,65),20);
                addLinkView("https://quizlet.com/mx/361282272/los-primeros-filosofos-flash-cards/?i=5di0h7&x=1jqt", "Los primos Filosofós", Color.rgb(15,51,65),20);
                addLinkView("https://view.genial.ly/651e1d6ac38fb20011a5416e/presentation-los-atomistas", "Los atómistas", Color.rgb(15,51,65),20);
                addLinkView("https://view.genial.ly/652ada978583d200111bc212/presentation-socrates", "Sócrates", Color.rgb(15,51,65),20);
            ...
            case "HISTORIA" :
                ...
                addLinkView("https://drive.google.com/file/d/1pl87Iz8ozjjMfU3rbAk2sKOXYKGH5lhd/view?usp=drive_link", "La primera Guerra Mundial y sus consecuencias", Color.rgb(15,51,65),20);
                addLinkView("https://drive.google.com/file/d/1WJydTkVnbJSjOOPNawsYcNz0sLHHxam9/view?usp=sharing", "La Revolución Rusa y El Fin de la Guerra",Color.rgb(15,51,65),20 );
                addLinkView("https://youtu.be/Vbu6tH0Hc-o?si=GgLXb7em3LPuv9X0", "La primera Guerra Mundial", Color.rgb(15,51,65),20);
            ...
            case "MATEMATICAS":
                ...
                addLinkView("https://www.youtube.com/playlist?list=PLeySRPnY35dHyUzy-YVDD9ZllhtXfcQ4_&si=mD36rtY4espFZ85r", "Logaritmos y ecuaciones", Color.rgb(15,51,65),20);
                ...
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        for (QueryDocumentSnapshot document : task.getResult()) {
                            ...
                            addLinkView(materialDeAyuda.get(index).getLink(),materialDeAyuda.get(index).getTema(),Color.rgb(15,51,65), 20 );
